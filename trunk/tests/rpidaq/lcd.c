...
// raspy-juice adaptation
// rs - pin12, GPIO1, bcmgpio18
// strb - pin11, GPIO0, bcmgpio17
//   
   
  fd1 = lcdInit (2, 20, 4, 1,  0,   3,4,5,6,9,9,9,9) ;
...
//fd2 = lcdInit (2, 16, 8, 8, 10,   0,1,2,3,4,5,6,7) ;
  ...
  lcdPosition (fd1, 0, 0) ; lcdPuts (fd1, "Dave Appleton") ;
    printf("Got out of lcdPuts Dave\n");
  lcdPosition (fd1, 0, 1) ; lcdPuts (fd1, "-------------") ;
    printf("Got out of lcdPuts ----\n");
/*
